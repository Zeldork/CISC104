...
public class CubeTests
{
    ...
    public void CubeDefaultConstructorTest()
    {
        ...
        Assert.AreEqual(12, defaultCube.GetEdgeLength());
    }
    ...
    public void CubeTwoByFourByTwoTest()
    {
        ...
        Assert.AreEqual(32, twoByFourByTwo.GetEdgeLength());
    }
    ...
    public void CubeTenByTenByTenTest()
    {
        ...
        Assert.AreEqual(120, tenByTenByTen.GetEdgeLength());
    }
    ...
    public void CubeThreeByThreeByTwoTest()
    {
        ...
        Assert.AreEqual(32, threeByThreeByTwo.GetEdgeLength());
    }
}
